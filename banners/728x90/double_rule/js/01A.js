...
TweenLite.to(thickRule, 0.5, {width:"236px",ease:Quart.easeInOut});
TweenLite.to(thickRule, 0.5, {height:"25px",delay:0.75,ease:Quart.easeInOut});
TweenLite.to(thickRule, 0.5, {height:"0px",delay:1.5,ease:Quart.easeInOut});

var thinRule = $(this).find(".thinRule");
TweenLite.to(thinRule, 0.5, {width:"236px",ease:Quart.easeInOut});
TweenLite.to(thinRule, 0.5, {height:"24px",delay:1.75,ease:Quart.easeInOut});

...
TweenLite.to(rule01, 0.5, {width:"236px",ease:Quart.easeInOut});
...
TweenLite.to(rule02, 0.5, {width:"236px",ease:Quart.easeInOut});
TweenLite.to(rule02, 0.5, {height:"24px",delay:0.75,ease:Quart.easeInOut});

...
/* /////////////////////////////////// NUMBER ONE /////////////////////////////////// */
$('#vr300x250_02').bind('click', numOne);
...
TweenLite.to(rule01T, 0.5, {height:"51px",ease:Quart.easeInOut});

var rule01B = $(this).find(".rule01B");
TweenLite.to(rule01B, 0.5, {height:"52px",ease:Quart.easeInOut});

var rule02T = $(this).find(".rule02T");
TweenLite.to(rule02T, 0.5, {opacity:"1.0",delay:0.5,ease:Quart.easeInOut});
TweenLite.to(rule02T, 0.5, {width:"48px",delay:1.0,ease:Quart.easeInOut});
...
TweenLite.to(rule02B, 0.5, {width:"48px",delay:1.0,ease:Quart.easeInOut});
...
TweenLite.to(rule02T, 0.5, {height:"51px",ease:Quart.easeInOut});
...
TweenLite.to(rule02B, 0.5, {height:"52px",ease:Quart.easeInOut});

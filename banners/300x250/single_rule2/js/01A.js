...
/* /////////////////////////////////// NUMBER ONE /////////////////////////////////// */
$('#sr2_300x250_01').bind('click', numOne);
...
TweenLite.to(thickRule, 0.5, {width:"187px",ease:Quart.easeInOut});
TweenLite.to(thickRule, 0.5, {height:"27px",delay:0.75,ease:Quart.easeInOut});

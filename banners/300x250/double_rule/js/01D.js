...
/* /////////////////////////////////// NUMBER ONE /////////////////////////////////// */
$('#dr300x250_02').bind('click', numOne);
...
TweenLite.to(rule01L, 0.5, {width:"127px",ease:Quart.easeInOut});
TweenLite.to(rule01L, 0.5, {height:"26px",delay:0.75,ease:Quart.easeInOut});
TweenLite.to(rule01L, 0.5, {height:"0px",delay:1.5,ease:Quart.easeInOut});

var rule01R = $(this).find(".rule01R");
TweenLite.to(rule01R, 0.5, {width:"128px",ease:Quart.easeInOut});
TweenLite.to(rule01R, 0.5, {height:"26px",delay:0.75,ease:Quart.easeInOut});
...
TweenLite.to(rule02L, 0.5, {width:"127px",ease:Quart.easeInOut});
TweenLite.to(rule02L, 0.5, {height:"26px",delay:1.75,ease:Quart.easeInOut});
...
TweenLite.to(rule02R, 0.5, {width:"127px",ease:Quart.easeInOut});
TweenLite.to(rule02R, 0.5, {height:"26px",delay:1.75,ease:Quart.easeInOut});

...
/* /////////////////////////////////// NUMBER ONE /////////////////////////////////// */
$('#sr2_300x600_04').bind('click', numOne);
...
TweenLite.to(rule01, 0.5, {width:"140px",ease:Quart.easeInOut});
TweenLite.to(rule01, 0.5, {height:"69px",delay:0.75,ease:Quart.easeInOut});
TweenLite.to(rule01, 0.5, {height:"0px",delay:1.5,ease:Quart.easeInOut});

var rule02 = $(this).find(".rule02");
TweenLite.to(rule02, 0.5, {width:"140px",ease:Quart.easeInOut});
...
TweenLite.to(rule02, 0.5, {height:"28px",delay:0.5,ease:Quart.easeInOut});

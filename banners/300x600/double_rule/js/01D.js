...
/* /////////////////////////////////// NUMBER ONE /////////////////////////////////// */
$('#dr300x600_02').bind('click', numOne);
...
TweenLite.to(rule01L, 0.5, {width:"92px",ease:Quart.easeInOut});
TweenLite.to(rule01L, 0.5, {height:"68px",delay:0.75,ease:Quart.easeInOut});
TweenLite.to(rule01L, 0.5, {height:"0px",delay:1.5,ease:Quart.easeInOut});

var rule01R = $(this).find(".rule01R");
TweenLite.to(rule01R, 0.5, {width:"93px",ease:Quart.easeInOut});
TweenLite.to(rule01R, 0.5, {height:"68px",delay:0.75,ease:Quart.easeInOut});
...
TweenLite.to(rule02L, 0.5, {width:"92px",ease:Quart.easeInOut});
...
TweenLite.to(rule02R, 0.5, {width:"93px",ease:Quart.easeInOut});
...
TweenLite.to(rule02L, 0.5, {height:"30px",ease:Quart.easeInOut});

var rule02R = $(this).find(".rule02R");
TweenLite.to(rule02R, 0.0, {opacity:"0.0",delay:1.0});
TweenLite.to(rule02R, 0.5, {width:"0px",delay:0.5,ease:Quart.easeInOut});
TweenLite.to(rule02R, 0.5, {height:"30px",ease:Quart.easeInOut});

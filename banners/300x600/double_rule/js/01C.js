...
/* /////////////////////////////////// NUMBER ONE /////////////////////////////////// */
$('#dr300x600_01').bind('click', numOne);
...
TweenLite.to(thickRule, 0.5, {width:"185px",ease:Quart.easeInOut});
TweenLite.to(thickRule, 0.5, {height:"68px",delay:0.75,ease:Quart.easeInOut});
TweenLite.to(thickRule, 0.5, {height:"0px",delay:1.5,ease:Quart.easeInOut});

var thinRule = $(this).find(".thinRule");
TweenLite.to(thinRule, 0.5, {width:"185px",ease:Quart.easeInOut});
...
TweenLite.to(thinRule, 0.5, {height:"30px",ease:Quart.easeInOut});

...
/* /////////////////////////////////// NUMBER ONE /////////////////////////////////// */
$('#sr2_160x600_01').bind('click', numOne);
...
TweenLite.to(thickRule, 0.5, {width:"90px",ease:Quart.easeInOut});
TweenLite.to(thickRule, 0.5, {height:"48px",delay:0.75,ease:Quart.easeInOut});

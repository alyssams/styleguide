...
! function (t) {
    ...
    s.prototype = {
        ...
        delegateEvents: function () {
            var e = this,
                o = ["focus" + i, "input" + i, "propertychange" + i, "keydown" + i, "keyup" + i, "dynamic" + i, "generateOnLoad" + i];
        ...
        generateRequestObject: function (e) {
            ...
            Object.defineProperty(n.request, "beforeSend", {
                writable: !1
            }), o.url[0] instanceof Object ? (o.url[0].callback && (n.extra.callback = o.url[0].callback, delete o.url[0].callback), n.request = t.extend(!0, n.request, o.url[0])) : "string" == typeof o.url[0] && (n.request.url = o.url[0]), o.url[1] && "string" == typeof o.url[1] && (n.extra.path = o.url[1]), "jsonp" === n.request.dataType.toLowerCase() && (n.request.jsonpCallback = "callback_" + e);
            var s;
            for (var r in this.requests)
                if (this.requests.hasOwnProperty(r) && (s = JSON.stringify(this.requests[r].request), s === JSON.stringify(n.request))) {
        ...
        handleRequests: function () {
            ...
            for (var o in this.requests) this.requests.hasOwnProperty(o) && (this.requests[o].isDuplicated || ! function (o, n) {
                ...
                var r, a = !1;
                if (~n.request.url.indexOf("{{query}}") && (a || (n = t.extend(!0, {}, n), a = !0), n.request.url = n.request.url.replace("{{query}}", e.query.sanitize())), n.request.data)
        ...
        searchResult: function (t) {
            if (t || (this.item = {}), this.resetLayout(), this.helper.executeCallback.call(this, this.options.callback.onSearch, [this.node, this.query]), !(this.query.length < this.options.minLength)) {
                var e, i, o, n, s, r, a, l, h, u, c, p, d = this,
            ...
            if (this.options.hint) {
                ...
                if (this.options.accent && (n = this.helper.removeAccent.call(this, n)), this.hintIndex = null, this.query.length >= this.options.minLength) {
                    if (this.hint.container || (this.hint.css = t.extend({
                        ...
                        for (var s, r, a, l = 0; l < e.length; l++) {
                            r = e[l].group, s = this.options.source[r].display || this.options.display;
                            for (var h = 0; h < s.length; h++)
                                if (a = String(e[l][s[h]]).toLowerCase(), this.options.accent && (a = this.helper.removeAccent.call(this, a)), 0 === a.indexOf(n)) {
        ...
        buildDropdownLayout: function () {
            ...
            if (this.options.dropdownFilter) {
                var o, n = this;
                if ("boolean" == typeof this.options.dropdownFilter) o = "all";
                else if ("string" == typeof this.options.dropdownFilter) o = this.options.dropdownFilter;
                else if (this.options.dropdownFilter instanceof Array)
                    for (var s = 0; s < this.options.dropdownFilter.length; s++)
                        if ("*" === this.options.dropdownFilter[s].value && this.options.dropdownFilter[s].display) {
                        ...
                        t(this).append(t("<button/>", {
                            ...
                            html: function () {
                                ...
                                for (var s = 0; s < i.length; s++) ! function (i, o, s) {
                                    (o.key || "*" === o.value) && o.value && ("*" === o.value && t(s).append(t("<li/>", {
                                        "class": "divider"
                                    })), t(s).append(t("<li/>", {
                                        html: t("<a/>", {
                                            href: "javascript:;",
        ...
        dynamicFilter: {
            ...
            bind: function () {
                if (this.options.dynamicFilter)
                    for (var e, o = this, n = 0; n < this.options.dynamicFilter.length; n++) e = this.options.dynamicFilter[n], "string" == typeof e.selector && (e.selector = t(e.selector)), e.selector instanceof jQuery && e.selector[0] && e.key && ! function (t) {
        ...
        typeahead: function (e, i) {
            if (i && i.source && "object" == typeof i.source) {
                ...
                if (e.length && "INPUT" === e[0].nodeName)
                    for (var o, n = 0; n < e.length; n++) o = 1 === e.length ? e : t(e.selector.split(",")[n].trim()), window.Typeahead[o.selector || i.input] = new s(o, i)
            }
        }
    };
